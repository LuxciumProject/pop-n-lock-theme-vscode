...
const nls = { localize: dummyLocalize };
// base themes
...
export const textSeparatorForeground = registerColor(
  ...
  dummyLocalize("textSeparatorForeground", "Color for text separators.")
);
export const textLinkForeground = registerColor(
  "textLink.foreground",
  { light: "#006AB1", dark: "#3794FF", hc: "#3794FF" },
  dummyLocalize("textLinkForeground", "Foreground color for links in text.")
);
...
export const pickerGroupBorder = registerColor(
  ...
  dummyLocalize("pickerGroupBorder", "Quick picker color for grouping borders.")
);

export const buttonForeground = registerColor(
  "button.foreground",
  { dark: Color.white, light: Color.white, hc: Color.white },
  dummyLocalize("buttonForeground", "Button foreground color.")
);
export const buttonBackground = registerColor(
  "button.background",
  { dark: "#0E639C", light: "#007ACC", hc: null },
  dummyLocalize("buttonBackground", "Button background color.")
);
...
export const menuBorder = registerColor(
  "menu.border",
  { dark: null, light: null, hc: contrastBorder },
  dummyLocalize("menuBorder", "Border color of menus.")
);
export const menuForeground = registerColor(
  "menu.foreground",
  { dark: selectForeground, light: foreground, hc: selectForeground },
  dummyLocalize("menuForeground", "Foreground color of menu items.")
);
export const menuBackground = registerColor(
  "menu.background",
  { dark: selectBackground, light: selectBackground, hc: selectBackground },
  dummyLocalize("menuBackground", "Background color of menu items.")
);
...
export const editorErrorBorder = registerColor(
  ...
  dummyLocalize("errorBorder", "Border color of error boxes in the editor.")
);
...
export const editorWarningBorder = registerColor(
  ...
  dummyLocalize("warningBorder", "Border color of warning boxes in the editor.")
);
...
export const editorInfoBorder = registerColor(
  ...
  dummyLocalize("infoBorder", "Border color of info boxes in the editor.")
);
...
export const editorHintBorder = registerColor(
  ...
  dummyLocalize("hintBorder", "Border color of hint boxes in the editor.")
);
...
export const editorBackground = registerColor(
  ...
  dummyLocalize("editorBackground", "Editor background color.")
);
...
export const editorForeground = registerColor(
  ...
  dummyLocalize("editorForeground", "Editor default foreground color.")
);
...
export const editorSelectionBackground = registerColor(
  ...
  dummyLocalize("editorSelectionBackground", "Color of the editor selection.")
);
...
export const editorFindMatch = registerColor(
  ...
  dummyLocalize("editorFindMatch", "Color of the current search match.")
);
...
export const editorHoverBackground = registerColor(
  ...
  dummyLocalize("hoverBackground", "Background color of the editor hover.")
);
export const editorHoverBorder = registerColor(
  ...
  dummyLocalize("hoverBorder", "Border color of the editor hover.")
);
...
export const editorActiveLinkForeground = registerColor(
  ...
  dummyLocalize("activeLinkForeground", "Color of active links.")
);
...
export const overviewRulerBracketMatchForeground = registerColor(
