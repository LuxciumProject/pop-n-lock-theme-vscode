...
const placeholder = '#1C1C2E';
export const colors = {
  // "quickInput.background": "#336",
  'quickInput.foreground': '#C4BDB5',
  ...
  'peekViewResult.selectionForeground': '#C4BDB5',
  'peekView.border': '#FC5D',
  'peekViewResult.background': '#52A2',
  'peekViewResult.fileForeground': '#C4BDB5',
  'peekViewResult.lineForeground': '#C4BDB5',
  'peekViewTitle.background': '#14B5',
  'peekViewTitleDescription.foreground': '#C4BDB5',
  'peekViewTitleLabel.foreground': '#C4BDB5',
  ...
  'breadcrumb.focusForeground': '#DCBD',
  'breadcrumb.foreground': '#DCBA',
  'breadcrumbPicker.background': '#2A255ADD',
  'tab.activeForeground': '#DCBD',
  'tab.unfocusedActiveForeground': '#DCBD',
  'tab.inactiveForeground': '#DCBA',
  'tab.unfocusedInactiveForeground': '#DCBA',
  'tab.hoverForeground': '#DCBF',
  'tab.unfocusedHoverForeground': '#DCBF',
  ...
  'tab.border': placeholder, // #1C1C2E,
  'notificationsInfoIcon.foreground': '#FC5',
  ...
  */
  ...
  'editor.findMatchHighlightBackground': '#39C4',
  ...
  'editor.lineHighlightBackground': '#15E2',
  'editor.lineHighlightBorder': '#E112',
  'editor.rangeHighlightBackground': '#2355',
  'editor.rangeHighlightBorder': '#7161',
  'editor.snippetFinalTabstopHighlightBackground': '#2359',
  'editor.snippetFinalTabstopHighlightBorder': '#2355',
  'editor.snippetTabstopHighlightBackground': '#2357',
  ...
  'editor.symbolHighlightBackground': '#42E5',
  'editor.symbolHighlightBorder': '#F42E',
  'list.activeSelectionBackground': '#39C7',
  // "list.activeSelectionForeground": "#C9BDB0EE",
  'editor.inactiveSelectionBackground': '#38D7', // #58E8
  'list.inactiveSelectionBackground': '#33D7',
  'list.inactiveSelectionForeground': '#DCBD',
  'editor.selectionBackground': '#42E7',
  ...
  'editorHoverWidget.statusBarBackground': placeholder, // #1C1C2E,
  'extensionButton.prominentHoverBackground': '#716C',
  'list.hoverBackground': '#7167',
  'list.hoverForeground': '#DCBD',
  'scrollbarSlider.hoverBackground': '#FC6B',
  'statusBarItem.hoverBackground': placeholder, // #1C1C2E,
  'statusBarItem.prominentHoverBackground': placeholder, // #1C1C2E,
  'welcomePage.buttonHoverBackground': '#39CC',
  'editorGroup.focusedEmptyBorder': placeholder, // #1C1C2E,
  'activityBar.activeFocusBorder': '#3C3',
  'list.inactiveFocusBackground': '#22E6',
  focusBorder: '#716A',
  'list.focusBackground': '#22E7',
  'list.focusForeground': '#FFF',
  'activityBar.activeBackground': '#716A',
  'activityBar.activeBorder': '#716',
  contrastActiveBorder: '#F150',
  'editorIndentGuide.activeBackground': '#4AE3',
  'editorLineNumber.activeForeground': '#DCBD',
  'editorLink.activeForeground': '#DCBD',
  'inputOption.activeBackground': '#7168',
  'inputOption.activeBorder': '#EA2B',
  'panelTitle.activeBorder': '#39CC',
  'panelTitle.activeForeground': '#DCBD',
  'scrollbarSlider.activeBackground': '#8B3B',
  'statusBarItem.activeBackground': placeholder, // #1C1C2E,
  'textLink.activeForeground': '#64CD',
  'titleBar.activeBackground': placeholder, // #1C1C2E,
  'titleBar.activeForeground': '#DCBD',
  'window.activeBorder': '#716A',
  'activityBar.inactiveForeground': '#C9BDB0AA',
  'panelTitle.inactiveForeground': '#DCBA',
  'titleBar.inactiveBackground': placeholder, // #1C1C2E,
  'titleBar.inactiveForeground': '#DCBA',
  'window.inactiveBorder': '#1b1b26',
  'activityBar.background': '#1C1C30',
  'activityBar.border': '#FC65',
  'activityBar.dropBackground': '#7165',
  'activityBar.foreground': '#C9BDB0',
  'activityBarBadge.background': '#39CC',
  'activityBarBadge.foreground': '#FC6C',
  'badge.background': '#39CC',
  'badge.foreground': '#FC6C',
  'extensionBadge.remoteBackground': '#716C',
  'extensionBadge.remoteForeground': '#C9BDB0',
  'button.background': '#716C',
  'button.foreground': '#C9BDB0',
  contrastBorder: '#DCB4',
  ...
  descriptionForeground: '#C9BDB0',
  'editor.background': '#20213B',
  'editor.foreground': '#DCBD',
  ...
  'editorGroup.emptyBackground': placeholder, // #1C1C2E,
  'editorGroupHeader.noTabsBackground': placeholder, // #1C1C2E,
  'editorGroupHeader.tabsBackground': placeholder, // #1C1C2E,
  ...
  'notificationCenterHeader.foreground': '#DCBD',
  ...
  // "notebook.cellToolbarSeperator": "#ff0000",
  // "notebook.focusedCellIndicator": "#ff0000",
...
/*
    ...
    "gitDecoration.untrackedResourceForeground": "#3C3",
    #DDCCAA #DCB
    #D6CAAF
    #CFC7B3 #DCB
    #C9C5B8
...
//     // #region "HTML" ----------------------------------------------------------
//     // "#BE5B" "#FC5D" "#ADCC" "#6BFC" "#C4BDB5" "#4B9D""#D79F" "#DF8E"
//     // "#fabE2fFF""#b8bb26FF""#8ec07cFF""#d3869bFF""#369ec7FF""#B35F""#C4BDB5"
