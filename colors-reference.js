const some = {
	...
	"colors": {
		...
		"activityBar.activeFocusBorder": "#33cc33",
		...
		"contrastBorder": "#ddccbb44",
		"debugExceptionWidget.background": "#1d2555ee",
		"debugExceptionWidget.border": "#ddccbb33",
		...
		"editorHint.foreground": "#ffcc55dd",
		"editorHoverWidget.background": "#1d2555ee",
		"editorHoverWidget.border": "#ddccbb55",
		...
		"editorMarkerNavigationInfo.background": "#ffcc55dd",
		...
		"editorOverviewRuler.infoForeground": "#ffcc55dd",
		"editorOverviewRuler.modifiedForeground": "#3399ccaa",
		"editorOverviewRuler.rangeHighlightForeground": "#ff7733cc",
		"editorOverviewRuler.selectionHighlightForeground": "#ffcc55dd",
		...
		"problemsInfoIcon.foreground": "#ffcc55dd",
		"problemsWarningIcon.foreground": "#ccff33",
		"progressBar.background": "#3399cccc",
		"quickInput.foreground": "#c4bdb5",
		"scrollbar.shadow": "#111122",
		"scrollbarSlider.activeBackground": "#88bb33bb",
		"scrollbarSlider.background": "#3399cc77",
		"scrollbarSlider.hoverBackground": "#ffcc66bb",
		...
		"symbolIcon.constantForeground": "#77aadd",
		"symbolIcon.constructorForeground": "#ee11aa",
		"symbolIcon.enumeratorForeground": "#ffbb22",
		"symbolIcon.enumeratorMemberForeground": "#66bbff",
		"symbolIcon.eventForeground": "#ffcc33",
		"symbolIcon.fieldForeground": "#66bbff",
		"symbolIcon.fileForeground": "#c4bdb5",
		"symbolIcon.folderForeground": "#c4bdb5",
		"symbolIcon.functionForeground": "#ffcc33",
		"symbolIcon.interfaceForeground": "#66bbff",
		"symbolIcon.keyForeground": "#c4bdb5",
		"symbolIcon.keywordForeground": "#dd2255",
		"symbolIcon.methodForeground": "#aa55bb",
		"symbolIcon.moduleForeground": "#aa55bb",
		...
		"tab.unfocusedHoverForeground": "#ddccbb",
		...
		//"activityBar.dropBorder": "#c9bdb0",
		//"button.secondaryBackground": "#3a3d41",
		//"button.secondaryForeground": "#ffffff",
		//"button.secondaryHoverBackground": "#45494e",
		//"checkbox.background": "#1c1e2a",
		//"checkbox.border": "#771166aa",
		//"checkbox.foreground": "#ddccbbdd",
		//"debugConsole.errorForeground": "#ddccbbbb",
		//"debugConsole.infoForeground": "#c9bdb0ee",
		//"debugConsole.sourceForeground": "#ddccbbdd",
		//"debugConsole.warningForeground": "#ccff33",
		//"debugConsoleInputIcon.foreground": "#ddccbbdd",
		...
		//"debugView.exceptionLabelForeground": "#ddccbbdd",
		//"debugView.stateLabelBackground": "#88888844",
		//"debugView.stateLabelForeground": "#ddccbbdd",
		...
		//"notebook.cellBorderColor": "#ddccbb22",
		//"notebook.cellHoverBackground": "#ddccbb11",
		//"notebook.cellInsertionIndicator": "#771166aa",
		//"notebook.cellStatusBarItemHoverBackground": "#ffffff26",
		//"notebook.cellToolbarSeparator": "#80808059",
		//"notebook.focusedCellBackground": "#ddccbb22",
		//"notebook.focusedCellBorder": "#ffffff1f",
		//"notebook.focusedEditorBorder": "#771166aa",
		//"notebook.outputContainerBackgroundColor": "#ddccbb22",
		//"notebook.symbolHighlightBackground": "#ffffff0b",
		//"notebookScrollbarSlider.activeBackground": "#88bb33bb",
		//"notebookScrollbarSlider.background": "#3399cc77",
		//"notebookScrollbarSlider.hoverBackground": "#ffcc66bb",
		//"notebookStatusErrorIcon.foreground": "#ddccbbbb",
		//"notebookStatusRunningIcon.foreground": "#ddccbbdd",
		//"notebookStatusSuccessIcon.foreground": "#89d185",
		//"panel.dropBorder": "#ddccbbdd",
		//"panelSection.border": "#ddccbb55",
		//"panelSection.dropBackground": "#2c203c",
		//"panelSectionHeader.background": "#80808033",
		//"panelSectionHeader.border": "#ddccbb44",
...
const myColorSet =  new Set (colorSetToReduce)

const shorterList = [... myColorSet]

shorterList.forEach(x=>console.log(x))