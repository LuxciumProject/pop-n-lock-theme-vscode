...
export const themeColor = new vscode.ThemeColor('dark1');
// themeColor.
export const original: any = {};
original.$schema = "vscode://schemas/color-theme";
original.name = "Pop N Lock Theme by Luxcium"
original.type = "dark"
original.colors = {};
export const originalX =
{

  "colors": {
    /* *** MAIN *** */
    "editorGutter.commentRangeForeground": "#53EA",
    "editor.background": "#202137",
    "editor.foreground": "#DCAD",
    "editorGutter.background": "#1D1C2F",
    "contrastActiveBorder": "#F150",
    "contrastBorder": "#DCA4",
    "errorForeground": "#DCAD",
    "progressBar.background": "#38AC",
    ...
    "activityBar.foreground": "#FECE",
    "activityBar.inactiveForeground": "#FEC8",
    "activityBarBadge.background": "#38AC",
    "activityBarBadge.foreground": "#FECE",
    "badge.background": "#38A",
    "badge.foreground": "#FECE",
    // #endregion
    // #region *** breadcrumb.activeSelectionForeground ***
    "breadcrumb.activeSelectionForeground": "#EDEB",
    "breadcrumb.background": "#1D2547",
    "breadcrumb.focusForeground": "#DCAD",
    "breadcrumb.foreground": "#DCAA",
    "breadcrumbPicker.background": "#2A255ADD",
    // #endregion
    // #region *** button.background ***
    "button.background": "#716C",
    "button.foreground": "#FECE",
    "button.hoverBackground": "#38AC",
    "extensionButton.prominentBackground": "#38A",
    "extensionButton.prominentForeground": "#FECE",
    "extensionButton.prominentHoverBackground": "#716C",
    "welcomePage.buttonBackground": "#716C",
    "welcomePage.buttonHoverBackground": "#38AC",
    // #endregion
    // #region *** debugExceptionWidget.background ***
    "debugExceptionWidget.background": "#1D2555EE",
    "debugExceptionWidget.border": "#DCA3",
    "debugToolBar.background": "#2C203C",
    "debugToolBar.border": "#52A5",
    /* *** "descriptionForeground": "  *** */
    "descriptionForeground": "#DCA8",
    // #endregion
    // #region *** diffEditor.border ***
    ...
    // #endregion
    // #region *** dropdown.background ***
    "dropdown.background": "#1C1E2A",
    "dropdown.border": "#716A",
    "dropdown.foreground": "#DCAD",
    "dropdown.listBackground": "#19152F",
    // #endregion
    // #region *** editor ***
    /* *** *** *** *** */
    "editor.findMatchBackground": "#38A5",
    "editor.findMatchBorder": "#34DD",
    "editor.findMatchHighlightBackground": "#38A4",
    "editor.findMatchHighlightBorder": "#38AD",
    ...
    "editor.inactiveSelectionBackground": "#58E8",
    ...
    /* *** *** *** *** */
    "editor.selectionBackground": "#53E6",
    "editor.selectionForeground": "#DCAD",
    "editor.selectionHighlightBackground": "#5276",
    "editor.selectionHighlightBorder": "#52AD",
    /* *** *** *** *** */
    ...
    /* *** *** *** *** */
    "editorCodeLens.foreground": "#DCA3",
    /* *** *** *** *** */
    "editorCursor.background": "#29153A",
    "editorCursor.foreground": "#C02030DD",
    /* *** *** *** *** */
    ...
    "editorGutter.modifiedBackground": "#38A",
    /* *** *** *** *** */
    "editorHoverWidget.background": "#1D2555EE",
    "editorHoverWidget.border": "#DCA3",
    "editorHoverWidget.statusBarBackground": "#1C1C2E",
    /* *** *** *** *** */
    "editorWhitespace.foreground": "#DCA2",
    "editorLineNumber.activeForeground": "#DCAA",
    "editorLineNumber.foreground": "#DCA5",
    "editorIndentGuide.activeBackground": "#4AE3",
    "editorIndentGuide.background": "#4AE1",
    /* *** *** *** *** */
    "editorLink.activeForeground": "#DCAD",
    /* *** *** *** *** */
    "editorMarkerNavigation.background": "#235",
    "editorMarkerNavigationError.background": "#B35",
    "editorMarkerNavigationInfo.background": "#38A",
    "editorMarkerNavigationWarning.background": "#FC6C",
    /* *** *** *** *** */
    "editorOverviewRuler.addedForeground": "#8B3A",
    "editorOverviewRuler.border": "#38AC",
    "editorOverviewRuler.bracketMatchForeground": "#AE4",
    "editorOverviewRuler.commonContentForeground": "#8DAA",
    "editorOverviewRuler.currentContentForeground": "#38AA",
    "editorOverviewRuler.deletedForeground": "#B35A",
    "editorOverviewRuler.errorForeground": "#F42C",
    "editorOverviewRuler.findMatchForeground": "#38A",
    "editorOverviewRuler.incomingContentForeground": "#E47A",
    "editorOverviewRuler.infoForeground": "#38AC",
    "editorOverviewRuler.modifiedForeground": "#38AA",
    "editorOverviewRuler.rangeHighlightForeground": "#F73C",
    "editorOverviewRuler.selectionHighlightForeground": "#FC5D",
    "editorOverviewRuler.warningForeground": "#694C",
    ...
    "editorSuggestWidget.border": "#6BFD",
    "editorSuggestWidget.foreground": "#EDAB",
    "editorSuggestWidget.highlightForeground": "#6BFD",
    "editorSuggestWidget.selectedBackground": "#4AE4",
    /* *** *** *** *** */
    "editorHint.foreground": "#FC5D",
    "editorHint.border": "#FC64",
    "editorInfo.foreground": "#6BFD",
    "editorInfo.border": "#4AE5",
    "editorWarning.foreground": "#BD2",
    "editorWarning.border": "#BD24",
    "editorError.foreground": "#F15",
    "editorError.border": "#F154",
    /* *** *** *** *** */
    "editorWidget.background": "#1D2555EE",
    "editorWidget.border": "#DCA5",
    "editorWidget.resizeBorder": "#38AE", /*  "#DCA3", */
    // #endregion
    // #region *** gitDecoration ***
    "gitDecoration.addedResourceForeground": "#FD5D",
    "gitDecoration.conflictingResourceForeground": "#F15B",
    "gitDecoration.deletedResourceForeground": "#C32B",
    "gitDecoration.ignoredResourceForeground": "#38AC",
    "gitDecoration.modifiedResourceForeground": "#EA2",
    "gitDecoration.submoduleResourceForeground": "#95BC",
    "gitDecoration.untrackedResourceForeground": "#8C3",
    // #endregion
    // #region *** input.background ***
    "inputOption.activeBorder": "#EA2B",
    "inputOption.activeBackground": "#7168",
    "input.background": "#38A3",
    "input.border": "#EA28",
    "input.foreground": "#FEDD",
    "input.placeholderForeground": "#FEDA",
    "inputValidation.errorBackground": "#722D",
    "inputValidation.errorBorder": "#F45",
    "inputValidation.errorForeground": "#FEDD",
    "inputValidation.infoBackground": "#235D",
    "inputValidation.infoBorder": "#38A",
    "inputValidation.infoForeground": "#FEDD",
    "inputValidation.warningBackground": "#752D",
    "inputValidation.warningBorder": "#FC5D",
    "inputValidation.warningForeground": "#FEDD",
    // #endregion
    // #region *** list.activeSelectionBackground ***
    "list.focusBackground": "#22E7",
    "list.activeSelectionBackground": "#38A7",
    "list.inactiveFocusBackground": "#22E6",
    "list.inactiveSelectionBackground": "#38A6",
    "list.hoverBackground": "#7167",
    "list.dropBackground": "#38A3",
    "list.activeSelectionForeground": "#EDCD",
    "list.errorForeground": "#F45",
    "list.focusForeground": "#FFF",
    "list.highlightForeground": "#7B5",
    "list.hoverForeground": "#DCAD",
    "list.inactiveSelectionForeground": "#DCAD",
    "list.invalidItemForeground": "#F42C",
    "list.warningForeground": "#8D5",
    /* *** listFilterWidget.background": "#426E", *** */
    ...
    "menu.border": "#7161",
    "menu.foreground": "#DCAD",
    "menu.selectionBackground": "#EB55",
    "menu.selectionBorder": "#52AD",
    "menu.selectionForeground": "#DCAD",
    "menu.separatorBackground": "#2C203C",
    /*
    /* *** MENU BAR *** */
    "menubar.selectionBackground": "#2955",
    "menubar.selectionBorder": "#6186",
    "menubar.selectionForeground": "#DCAD",
    // #endregion
    // #region *** MERGE ***
    "merge.border": "#38AC",
    ...
    "panel.border": "#DCA3",
    "panel.dropBackground": "#201C39",
    /* *** *** *** *** */
    "panelInput.border": "#7165",
    /* *** *** *** *** */
    "panelTitle.activeBorder": "#38AC",
    "panelTitle.activeForeground": "#DCAD",
    "panelTitle.inactiveForeground": "#DCAB",
    "peekView.border": "#FC5D", // "#FC5D", ,
    "peekViewEditor.background": "#235B",
    "peekViewEditor.matchHighlightBackground": "#426",
    ...
    // "peekViewTitle.background": "#25E6",
    "peekViewTitleDescription.foreground": "#EDAB",
    "peekViewTitleLabel.foreground": "#EDAB", // ! F
    /*
    ...
    "peekViewResult.background": "#52A2",
    "peekViewResult.fileForeground": "#DCAC",
    "peekViewResult.lineForeground": "#DCAC",
    "peekViewResult.matchHighlightBackground": "#38A5",
    "peekViewResult.selectionBackground": "#42B4",
    "peekViewResult.selectionForeground": "#DCAC",
    "peekViewTitle.background": "#14B5",
    "peekViewTitleDescription.foreground": "#DCAC",
    "peekViewTitleLabel.foreground": "#FC5D", ,
    /* *** *** *** *** */
    "pickerGroup.border": "#7161",
    "pickerGroup.foreground": "#DCAD",
    // #endregion
    // #region *** SCROLL BAR ***
    "scrollbarSlider.activeBackground": "#8B3B",
    "scrollbarSlider.background": "#38A7",
    "scrollbarSlider.hoverBackground": "#FC6B",
    "scrollbar.shadow": "#112",
    // #endregion
    // #region *** settings.checkboxBackground ***
    "settings.checkboxBackground": "#38A4",
    "settings.checkboxBorder": "#FC67",
    "settings.checkboxForeground": "#DCAD",
    "settings.dropdownBackground": "#7164",
    "settings.dropdownBorder": "#FC67",
    "settings.dropdownForeground": "#DCAD",
    "settings.dropdownListBorder": "#FC6B",
    "settings.headerForeground": "#DCAD",
    "settings.modifiedItemIndicator": "#8B3",
    "settings.numberInputBackground": "#38A4",
    "settings.numberInputBorder": "#FC64",
    "settings.numberInputForeground": "#DCAD",
    "settings.textInputBackground": "#7164",
    "settings.textInputBorder": "#FC64",
    "settings.textInputForeground": "#DCAD",
    // #endregion
    // #region *** SIDE BAR ***
    "sideBar.background": "#1D1028",
    "sideBar.border": "#FC68",
    "sideBar.dropBackground": "#7493",
    "sideBar.foreground": "#DCAD",
    "sideBarSectionHeader.background": "#7166",
    "sideBarSectionHeader.border": "#FBA5",
    "sideBarSectionHeader.foreground": "#DCAD",
    "sideBarTitle.foreground": "#DCAD",
    // #endregion
    // #region *** STATUS BAR ***
    "statusBar.background": "#1D2547",
    "statusBar.border": "#7160",
    "statusBar.debuggingBackground": "#C60",
    "statusBar.debuggingBorder": "#7160",
    "statusBar.debuggingForeground": "#DCAD",
    "statusBar.foreground": "#DCAA",
    "statusBar.noFolderBackground": "#848",
    "statusBar.noFolderBorder": "#7160",
    "statusBar.noFolderForeground": "#DCAD",
    // #endregion
    // #region *** STATUS BAR ITEM ***
    "statusBarItem.activeBackground": "#1C1C2E",
    "statusBarItem.hoverBackground": "#1C1C2E",
    "statusBarItem.prominentBackground": "#694",
    "statusBarItem.prominentForeground": "#DCAD",
    "statusBarItem.prominentHoverBackground": "#1C1C2E",
    // #endregion
    // #region *** tab.activeBackground ***
    "tab.activeBackground": "#1D2545",
    "tab.activeBorder": "#1D254500",
    "tab.activeBorderTop": "#AE4F", // ! F
    "tab.activeForeground": "#DCAD",
    "tab.activeModifiedBorder": "#F42F", // ! F
    "tab.border": "#1C1C2E",
    "tab.hoverBackground": "#52A5",
    "tab.hoverBorder": "#38A",
    "tab.inactiveBackground": "#2A2040",
    "tab.inactiveForeground": "#FC68",
    "tab.inactiveModifiedBorder": "#E3DB",
    "tab.unfocusedActiveBorder": "#1D254500",
    "tab.unfocusedActiveBorderTop": "#FB9A",
    "tab.unfocusedActiveForeground": "#FC68",
    "tab.unfocusedActiveModifiedBorder": "#F45D",
    "tab.unfocusedHoverBackground": "#52A4",
    "tab.unfocusedHoverBorder": "#38AD",
    "tab.unfocusedInactiveForeground": "#FC68",
    "tab.unfocusedInactiveModifiedBorder": "#E5D7",
    // #endregion
    // #region *** textBlockQuote.background ***
    "textBlockQuote.background": "#2C203C",
    "textBlockQuote.border": "#7161",
    "textCodeBlock.background": "#2C203C",
    "textLink.activeForeground": "#64CA",
    "textLink.foreground": "#6AFD",
    "textPreformat.foreground": "#DCAD",
    "textSeparator.foreground": "#DCAD",
    // #endregion
    // #region *** TITTLE BAR ***
    "titleBar.activeBackground": "#1C1C2E",
    "titleBar.activeForeground": "#DCAA",
    "titleBar.border": "#1C1C2E",
    "titleBar.inactiveBackground": "#1C1C2E",
    "titleBar.inactiveForeground": "#DCA5",
    // #endregion
    // #region *** TERMINAL ***
...
support.function.console.js
    */
    ...
    // #endregion
    // #region "JSON" ----------------------------------------------------------
    // "#FC5D","#9C8D","#CE5C","#D89D","#5BED","#DDDD","#39ED"
    {
